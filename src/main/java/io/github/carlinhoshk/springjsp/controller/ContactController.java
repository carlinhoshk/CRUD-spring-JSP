package io.github.carlinhoshk.springjsp.controller;

import io.github.carlinhoshk.springjsp.model.Contact;
import io.github.carlinhoshk.springjsp.service.ContactService;
...
public class ContactController {
    ...
    public String deletContact(@PathVariable int id){
        contactService.deletByid(id);
        return "redirect:/read-contact";
    }
}
